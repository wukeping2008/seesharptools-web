...
# SeeSharpTools-Web 一键部署脚本 (seesharp.alethealab.cn)
# 目标服务器: 8.155.57.140
# 用户: root
...
echo "🚀 开始部署 SeeSharpTools-Web 项目到 seesharp.alethealab.cn..."
...
# 创建Nginx配置 - 针对 seesharp.alethealab.cn
echo "⚙️ 创建Nginx配置..."
...
if ! command -v sshpass &> /dev/null; then
    ...
    echo "3. ssh root@8.155.57.140 'bash /tmp/deploy/server-deploy.sh'"
    exit 1
fi
...
echo ""
echo "✅ SeeSharpTools-Web 已成功部署到 seesharp.alethealab.cn！"
