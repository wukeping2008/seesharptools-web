...
/// <summary>
/// JYUSB1601 Single channel continuous mode data  
/// Author：JYTEK
...
/// 3. Press the start button to start continuous data acquisition
/// </summary>
    ...
    public partial class MainForm : Form
    {
        ...
        private void button_start_Click(object sender, EventArgs e)
        {
            try
            {
               ...
               catch (JYDriverException ex)
               {
                ...
                toolStripStatusLabel.Text = "Start AITask";
            }
        ...
        private void button_stop_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (aiTask != null) //Determine if the task exists
                {
                    //stop
                    aiTask.Stop();
