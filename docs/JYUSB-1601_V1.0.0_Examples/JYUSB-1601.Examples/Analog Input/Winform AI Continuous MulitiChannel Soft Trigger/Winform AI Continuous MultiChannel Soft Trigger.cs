...
/// <summary>
/// JYUSB1601 multi-channel continuous data acquisition (software trigger)
/// Author：JYTEK
...
namespace SeeSharpExample.JY.JYUSB1601
{
    public partial class MainForm : Form
    {
        ...
        /// <summary>
        /// the Buffer of data after readValue transpose, the capacity is the same as readValu
        /// </summary>
        double[,] displayValue;
        ...
        private void button_sendSoftTrigger_Click(object sender, EventArgs e)
        {
            ...
            toolStripStatusLabel.Text = "Send software trigger complete";
            button_start.Enabled = false;
            button_sendSoftTrigger.Enabled = false;
            button_stop.Enabled = true;
        }
